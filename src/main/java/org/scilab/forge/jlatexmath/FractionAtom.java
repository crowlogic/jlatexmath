 ...
 */
public class FractionAtom extends
                          Atom
{
  ...
  public Box createBox(TeXEnvironment env)
  {
    ...
    Box num   = (numerator == null ? new StrutBox(0,
                                                  0,
                                                  0,
                                                  0) : numerator.createBox(env.numStyle()));
    Box denom = (denominator == null ? new StrutBox(0,
                                                    0,
                                                    0,
                                                    0) : denominator.createBox(env.denomStyle()));

    if (num.getWidth() < denom.getWidth())
      num = new HorizontalBox(num,
                              denom.getWidth(),
                              numAlign);
    else
      denom = new HorizontalBox(denom,
                                num.getWidth(),
                                denomAlign);
    ...
    { // WITH fraction rule
      ...
      vBox.add(new StrutBox(0,
                            ...
                            0,
                            0));
      vBox.add(new HorizontalRule(thickness,
                                  num.getWidth(),
                                  0));
      vBox.add(new StrutBox(0,
                            kern2,
    ...
    float f = new SpaceAtom(TeXConstants.UNIT_EM,
                            0.12f,
                            0,
                            0).createBox(env).getWidth();

    return new HorizontalBox(vBox,
                             vBox.getWidth() + 2 * f,
