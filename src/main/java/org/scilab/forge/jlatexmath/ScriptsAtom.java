 ...
 */
public class ScriptsAtom extends
                         Atom
{

  // TeX constant: what's the use???
  private final static SpaceAtom SCRIPT_SPACE = new SpaceAtom(TeXConstants.UNIT_POINT,
                                                              0.5f,
                                                              0,
                                                              0);
  ...
  {
    Box b           = (base == null ? new StrutBox(0,
                                                   0,
                                                   0,
                                                   0) : base.createBox(env));
    Box deltaSymbol = new StrutBox(0,
                                   0,
                                   0,
                                   0);
    ...
    else
    {
      ...
      if (base.type_limits == TeXConstants.SCRIPT_LIMITS
        ...
        return new UnderOverAtom(new UnderOverAtom(base,
                                                   subscript,
                                                   TeXConstants.UNIT_POINT,
                                                   0.3f,
                                                   true,
                                                   false),
                                 superscript,
      ...
      else if (base instanceof SymbolAtom && base.type == TeXConstants.TYPE_BIG_OPERATOR)
