...
public final class JLaTeXMathCache
{
   ...
   */
  public static int[] getCachedTeXFormulaDimensions(String f,
                                                    int style,
                                                    int type,
                                                    int size,
                                                    int inset,
  ...
  {
    return getCachedTeXFormulaDimensions(new CachedTeXFormula(f,
                                                              style,
                                                              type,
                                                              size,
                                                              inset,
  ...
  public static int[] getCachedTeXFormulaDimensions(Object o) throws ParseException
  {
    ...
    return new int[]
    { cached.width, cached.height, cached.depth };
  }
  ...
  public static Object
         getCachedTeXFormula(String f, int style, int type, int size, int inset, Color fgcolor) throws ParseException
  {
    CachedTeXFormula           cached = new CachedTeXFormula(f,
                                                             style,
                                                             type,
                                                             size,
                                                             inset,
   ...
   * @param inset the inset to add on the top, bottom, left and right
   */
  public static void removeCachedTeXFormula(String f,
                                            int style,
                                            int type,
                                            int size,
                                            int inset,
                                            Color fgcolor) throws ParseException
  {
    cache.remove(new CachedTeXFormula(f,
                                      style,
                                      type,
                                      size,
                                      inset,
  ...
  /**
   * Remove a formula from the cache. Take care, remove the Object o, invalidate
   * it !
   * 
   * @param o an Object to identify the image in the cache
   */
   ...
   * @return the key in the map
   */
  public static Object paintCachedTeXFormula(String f,
                                             int style,
                                             int type,
                                             int size,
                                             int inset,
  ...
  {
    return paintCachedTeXFormula(new CachedTeXFormula(f,
                                                      style,
                                                      type,
                                                      size,
                                                      inset,
  ...
  public static Object
         paintCachedTeXFormula(String f, int style, int size, int inset, Graphics2D g) throws ParseException
  {
   ...
   */
  public static Image getCachedTeXFormulaImage(String f,
                                               int style,
                                               int type,
                                               int size,
                                               int inset,
                                               Color fgcolor) throws ParseException
  {
    return getCachedTeXFormulaImage(new CachedTeXFormula(f,
                                                         style,
                                                         type,
                                                         size,
                                                         inset,
  ...
  private static SoftReference<CachedImage> makeImage(CachedTeXFormula cached) throws ParseException
  {
    ...
    icon.setInsets(new Insets(cached.inset,
                              cached.inset,
                              cached.inset,
                              cached.inset));
    ...
    SoftReference<CachedImage> img = new SoftReference<CachedImage>(new CachedImage(image,
                                                                                    cached),
                                                                    queue);
