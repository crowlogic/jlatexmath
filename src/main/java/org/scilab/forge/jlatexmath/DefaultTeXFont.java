 ...
 */
public class DefaultTeXFont implements
                            TeXFont
{
  ...
  protected static final int                                      WIDTH               = 0, HEIGHT = 1, DEPTH = 2,
                IT = 3;
  ...
  {
    DefaultTeXFontParser dtfp = new DefaultTeXFontParser(in,
                                                         name);
  ...
  {
    DefaultTeXFontParser dtfp = new DefaultTeXFontParser(base,
                                                         in,
                                                         name);
    fontInfo = dtfp.parseFontDescriptions(fontInfo);
    dtfp.parseExtraPath();
  ...
  public static void addAlphabet(Character.UnicodeBlock alphabet,
                                 InputStream inlanguage,
                                 String language,
                                 InputStream insymbols,
                                 String symbols,
                                 InputStream inmappings,
                                 String mappings) throws ResourceParseException
  {
  ...
  public static void
         addAlphabet(Object base, Character.UnicodeBlock[] alphabet, String language) throws ResourceParseException
  {
    boolean b = false;
  ...
  public static void addAlphabet(Character.UnicodeBlock alphabet, String name)
  {
    ...
    try
    {
      DefaultTeXFont.addAlphabet(alphabet,
                                 TeXFormula.class.getResourceAsStream(lg),
                                 lg,
                                 TeXFormula.class.getResourceAsStream(sym),
                                 sym,
                                 TeXFormula.class.getResourceAsStream(map),
                                 map);
    }
  ...
  public Char getChar(CharFont cf, int style)
  {
    ...
    return new Char(cf.c,
                    font,
                    id,
                    getMetrics(cf, factor * fsize));
  }
  ...
  public Extension getExtension(Char c, int style)
  {
    ...
    for (int i = 0; i < ext.length; i++)
    {
      ...
      {
        parts[i] = new Char((char) ext[i],
                            f,
                            fc,
                            getMetrics(new CharFont((char) ext[i],
                                                    fc),
                                       s));
      }
    }

    return new Extension(parts[TOP],
                         parts[MID],
                         parts[REP],
                         parts[BOT]);
  }
  ...
  private Metrics getMetrics(CharFont cf, float size)
  {
    ...
    return new Metrics(m[WIDTH],
                       m[HEIGHT],
                       m[DEPTH],
                       m[IT],
                       size * TeXFormula.PIXELS_PER_POINT,
                       size);
  }
