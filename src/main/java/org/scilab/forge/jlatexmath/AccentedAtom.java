 ...
 */
public class AccentedAtom extends
                          Atom
{
    ...
    else
    {
      ...
      if (root instanceof SymbolAtom)
      {
        ...
        if (accent.type == TeXConstants.TYPE_ACCENT)
          ...
          throw new InvalidSymbolTypeException("The accent TeXFormula represents a single symbol with the name '"
  ...
  public Box createBox(TeXEnvironment env)
  {
    ...
    Box     b     = (base == null ? new StrutBox(0,
                                                 0,
                                                 0,
                                                 0) : base.createBox(env.crampStyle()));
    ...
    if (diff < 0)
    {
      HorizontalBox hb = new HorizontalBox(new StrutBox(diff,
                                                        0,
                                                        0,
                                                        0));
      hb.add(vBox);
