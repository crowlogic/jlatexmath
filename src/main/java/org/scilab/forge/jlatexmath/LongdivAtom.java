 ...
 */
public class LongdivAtom extends
                         VRowAtom
{
  ...
  public LongdivAtom(long divisor, long dividend)
  {
    ...
    Atom     rule = new RuleAtom(TeXConstants.UNIT_EX,
                                 0f,
    ...
    for (int i = 0; i < res.length; ++i)
    {
      ...
      else if (i == 1)
      {
        ...
        Atom       big    = new BigDelimiterAtom(rparen,
                                                 1);
        Atom       ph     = new PhantomAtom(big,
                                            false,
                                            true,
                                            true);
        RowAtom    ra     = new RowAtom(ph);
        Atom       raised = new RaiseAtom(big,
                                          TeXConstants.UNIT_X8,
                                          3.5f,
                                          TeXConstants.UNIT_X8,
                                          0f,
                                          TeXConstants.UNIT_X8,
