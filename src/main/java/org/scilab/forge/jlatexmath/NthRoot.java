                     ...
                     Atom
{
  ...
  public Box createBox(TeXEnvironment env)
  {
    ...
    b.add(new SpaceAtom(TeXConstants.UNIT_MU,
                        1,
                        0,
                        0).createBox(env.crampStyle()));
    // create root sign
    ...
    { // nthRoot, not a simple square root
      ...
      // negative kern
      Box   negativeKern = new SpaceAtom(TeXConstants.UNIT_MU,
                                         -10f,
                                         0,
                                         0).createBox(env);
