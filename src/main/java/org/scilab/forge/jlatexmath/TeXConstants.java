...
public class TeXConstants
{
   ...
   * <p>
   * The large versions of big operators are used and limits are placed under and
   * over these operators (default). Symbols are rendered in the largest size.
   */
   ...
   * <p>
   * The small versions of big operators are used and limits are attached to these
   * operators as scripts (default). The same size as in the display style is used
   * to render symbols.
   */
