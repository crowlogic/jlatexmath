...
public interface Row
{
   ...
   * another composed atom, so this composed atom will be a child of it (nested).
   * This is necessary to determine the glue to insert between the first child
   * atom of this nested composed atom and the atom that the dummy contains.
   *
