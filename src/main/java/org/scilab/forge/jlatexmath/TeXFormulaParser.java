...
public class TeXFormulaParser
{
  ...
  private class MethodInvocationParser implements
                                       ActionParser
  {
    ...
    public void parse(Element el) throws ResourceParseException
    {
      ...
      {// doesn't exist
        throw new XMLResourceParseException(PredefinedTeXFormulaParser.RESOURCE_NAME,
                                            "Argument",
                                            ARG_OBJ_ATTR,
                                            "has an unknown temporary TeXFormula name as value : '" + objectName
                                                          + "'!");
      }
      else
      {
  ...
  private class CreateTeXFormulaParser implements
                                       ActionParser
  {
    ...
    public void parse(Element el) throws ResourceParseException
    {
      ...
      // String code = "TeXFormula.predefinedTeXFormulasAsString.put(\"%s\",
      // \"%s\");";
  ...
  private class CreateCommandParser implements
                                    ActionParser
  {
  ...
  private class FloatValueParser implements
                                 ArgumentValueParser
  {
    ...
    public Object parseValue(String value, String type) throws ResourceParseException
    {
      ...
      catch (NumberFormatException e)
      {
        throw new XMLResourceParseException(PredefinedTeXFormulaParser.RESOURCE_NAME,
                                            "Argument",
                                            ARG_VAL_ATTR,
                                            "has an invalid '" + type + "'-value : '" + value + "'!",
                                            e);
      }
    }
  }

  private class CharValueParser implements
                                ArgumentValueParser
  {
  ...
  private class BooleanValueParser implements
                                   ArgumentValueParser
  {
  ...
  private class IntValueParser implements
                               ArgumentValueParser
  {
  ...
  private class ReturnParser implements
                             ActionParser
  {
    ...
    public void parse(Element el) throws ResourceParseException
    {
      ...
      if (res == null)
      {
        throw new XMLResourceParseException(PredefinedTeXFormulaParser.RESOURCE_NAME,
                                            RETURN_EL,
                                            "name",
                                            "contains an unknown temporary TeXFormula variable name '" + name
  ...
  private class StringValueParser implements
                                  ArgumentValueParser
  {
  ...
  private class TeXFormulaValueParser implements
                                      ArgumentValueParser
  {
      ...
      else
      {
        ...
        {// unknown temporary TeXFormula!
          throw new XMLResourceParseException(PredefinedTeXFormulaParser.RESOURCE_NAME,
                                              "Argument",
                                              ARG_VAL_ATTR,
                                              "has an unknown temporary TeXFormula name as value : '" + value
                                                            + "'!");
        }
        else
        {
  ...
  private class TeXConstantsValueParser implements
                                        ArgumentValueParser
  {
  ...
  private class ColorConstantValueParser implements
                                         ArgumentValueParser
  {
