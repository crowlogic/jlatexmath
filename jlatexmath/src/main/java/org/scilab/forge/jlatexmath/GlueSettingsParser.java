...
public class GlueSettingsParser
{
  ...
  public GlueSettingsParser() throws ResourceParseException
  {
    try
    {
      ...
      root = factory.newDocumentBuilder()
                    .parse(GlueSettingsParser.class.getResourceAsStream(RESOURCE_NAME))
                    .getDocumentElement();
      parseGlueTypes();
    }
    catch (Exception e)
  ...
  private static void checkMapping(Object val,
                                   String elementName,
                                   String attrName,
                                   String attrValue) throws ResourceParseException
  {
    if (val == null)
      throw new XMLResourceParseException(RESOURCE_NAME,
                                          elementName,
