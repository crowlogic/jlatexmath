 ...
 * over or under it.
 */
public class UnderOverArrowAtom extends
                                Atom
{
  ...
  {
    Box   b   = base != null ? base.createBox(env) : new StrutBox(0,
                                                                  0,
                                                                  0,
                                                                  0);
    float sep = new SpaceAtom(TeXConstants.UNIT_POINT,
                              1f,
                              0,
