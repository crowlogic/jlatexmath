 ...
 */
public class SymbolAtom extends
                        CharSymbol
{
  ...
  {
    TeXSymbolParser tsp = new TeXSymbolParser(in,
                                              name);
  ...
  public Box createBox(TeXEnvironment env)
  {
    ...
    if (env.getSmallCap() && unicode != 0 && Character.isLowerCase(unicode))
    {
      try
      {
        cb = new ScaleBox(new CharBox(tf.getChar(TeXFormula.symbolTextMappings[Character.toUpperCase(unicode)],
                                                 style)),
                          0.8,
                          0.8);
      }
