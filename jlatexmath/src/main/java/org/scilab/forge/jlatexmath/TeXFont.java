...
public interface TeXFont
{
   ...
   *         style
   * @throws TextStyleMappingNotFoundException if there's no text style defined
   *                                           with the given name
   */
   ...
   * information
   *
   * @param cf    CharFont-object determining a specific character of a specific
   *              font
   * @param style the style in which the atom should be drawn
   ...
   * @throws SymbolMappingNotFoundException if there's no symbol defined with the
   *                                        given name
   */
   ...
   * @param c     alphanumeric character
   * @param style the style in which the atom should be drawn
   * @return the Char-object specifying the given character in the default text
   *         style
   */
  ...
  /**
   * Get the kern value to be inserted between the given characters in the given
   * style.
   *
  ...
  /**
   * Get the kern amount of the character defined by the given CharFont followed
   * by the "skewchar" of it's font. This is used in the algorithm for placing an
   * accent above a single character.
   *
   ...
   *
   * @param c a character
   * @return true if the given character contains extension information to buid an
   *         arbitrary large version of this character.
   */
