...
public class PredefMacros
{
  ...
  public static final Atom longdiv_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    try
    {
      ...
      return new LongdivAtom(divisor,
                             dividend);
    }
  ...
  {
    return new StrikeThroughAtom(new TeXFormula(tp,
                                                args[1],
                                                false).root);
  }
  ...
  public static final Atom Braket_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    return new TeXFormula(tp,
                          "\\left\\langle " + str + "\\right\\rangle").root;
  }
  ...
  public static final Atom hvspace_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    return args[0].charAt(0) == 'h' ? new SpaceAtom(unit,
                                                    f,
                                                    0,
                                                    0) : new SpaceAtom(unit,
                                                                       0,
                                                                       f,
                                                                       0);
  }
  ...
  {
    return new LapedAtom(new TeXFormula(tp,
                                        args[1]).root,
                         args[0].charAt(0));
  }
  ...
  public static final Atom rule_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    return new RuleAtom((int) winfo[0],
                        winfo[1],
                        (int) hinfo[0],
                        hinfo[1],
                        (int) rinfo[0],
  ...
  public static final Atom cfrac_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    TeXFormula num   = new TeXFormula(tp,
                                      args[1],
                                      false);
    TeXFormula denom = new TeXFormula(tp,
                                      args[2],
                                      false);
    ...
    Atom    f   = new FractionAtom(num.root,
                                   denom.root,
                                   true,
                                   alig,
  ...
  public static final Atom frac_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    if (num.root == null || denom.root == null)
      throw new ParseException("Both numerator and denominator of a fraction can't be empty!");
    return new FractionAtom(num.root,
                            denom.root,
                            true);
  }
  ...
  public static final Atom sfrac_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    if (!tp.isMathMode())
    {
      ...
      shiftL = -0.24f;
      shiftR = -0.24f;
      slash  = new VRowAtom(new ScaleAtom(SymbolAtom.get("textfractionsolidus"),
                                          1.25,
                                          0.65));
      ((VRowAtom) slash).setRaise(TeXConstants.UNIT_EX, 0.4f);
    }

    VRowAtom snum = new VRowAtom(new ScaleAtom(num.root,
                                               scaleX,
                                               scaleY));
    ...
    at.add(new SpaceAtom(TeXConstants.UNIT_EM,
                         ...
                         0f,
                         0f));
    at.add(new ScaleAtom(denom.root,
                         scaleX,
                         scaleY));
  ...
  {
    TeXFormula left = new TeXFormula(tp,
                                     args[1],
                                     false);
    ...
    TeXFormula right = new TeXFormula(tp,
                                      args[2],
                                      false);
    ...
    if (num.root == null || denom.root == null)
      throw new ParseException("Both numerator and denominator of a fraction can't be empty!");
    Atom    at  = new FractionAtom(num.root,
                                   denom.root,
                                   rule,
                                   (int) ths[0],
                                   ths[1]);
  ...
  public static final Atom over_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    Atom denom = new TeXFormula(tp,
                                tp.getOverArgument(),
                                false).root;
    if (num == null || denom == null)
      throw new ParseException("Both numerator and denominator of a fraction can't be empty!");
    return new FractionAtom(num,
                            denom,
                            true);
  }
  ...
  public static final Atom overwithdelims_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    {
      return new FencedAtom(new FractionAtom(num,
                                             denom,
                                             true),
                            (SymbolAtom) left,
                            (SymbolAtom) right);
  ...
  public static final Atom choose_brackets(final String left,
                                           final String right,
                                           final TeXParser tp,
  ...
  public static final Atom binom_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    return new FencedAtom(new FractionAtom(num.root,
                                           denom.root,
                                           false),
                          new SymbolAtom("lbrack",
                                         TeXConstants.TYPE_OPENING,
                                         true),
                          new SymbolAtom("rbrack",
                                         TeXConstants.TYPE_CLOSING,
                                         true));
  }
  ...
  public static final Atom textstyle_macros(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    if ("frak".equals(args[0]))
      ...
      return new BoldAtom(new TeXFormula(tp,
                                         args[1],
                                         false).root);
  ...
  {
    return new RomanAtom(new TeXFormula(tp,
                                        args[1],
                                        "mathnormal",
                                        false,
                                        false).root);
  ...
  {
    return new AccentedAtom(new TeXFormula(tp,
                                           args[1],
                                           false).root,
                            args[0]);
  }
  ...
  {
    return new CedillaAtom(new TeXFormula(tp,
                                          args[1]).root);
  }
  ...
  {
    return new OgonekAtom(new TeXFormula(tp,
                                         args[1]).root);
  }
  ...
  {
    if (args[2] == null)
      return new NthRoot(new TeXFormula(tp,
                                        args[1],
                                        false).root,
                         null);
    return new NthRoot(new TeXFormula(tp,
  ...
  {
    return new UnderOverArrowAtom(new TeXFormula(tp,
                                                 args[1],
                                                 false).root,
                                  false,
                                  true);
  ...
  {
    return new XArrowAtom(new TeXFormula(tp,
                                         args[1],
                                         false).root,
                          new TeXFormula(tp,
                                         args[2]).root,
  ...
  public static final Atom sideset_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    tf.add(new PhantomAtom(new TeXFormula(tp,
                                          args[3]).root,
                           false,
                           true,
                           true));
    tf.append(tp.getIsPartial(), args[1]);
    tf.add(new SpaceAtom(TeXConstants.UNIT_MU,
                         -0.3f,
                         0f,
                         0f));
  ...
  {
    Atom base = new TeXFormula(tp,
                               args[3]).root;
    tp.addAtom(new ScriptsAtom(new PhantomAtom(base,
                                               false,
                                               true,
                                               true),
                               new TeXFormula(tp,
                               ...
                               new TeXFormula(tp,
                                              args[1]).root,
                               false));
    tp.addAtom(new SpaceAtom(TeXConstants.UNIT_MU,
                             -0.3f,
                             0f,
                             0f));
    return new TypedAtom(TeXConstants.TYPE_ORDINARY,
  ...
  {
    return new OverUnderDelimiter(new TeXFormula(tp,
                                                 args[1],
                                                 false).root,
                                  null,
                                  SymbolAtom.get("rbrace"),
                                  TeXConstants.UNIT_EX,
                                  0,
                                  false);
  }
  ...
  {
    return new OverlinedAtom(new TeXFormula(tp,
                                            args[1],
                                            false).root);
  }
  ...
  {
    return new UnderlinedAtom(new TeXFormula(tp,
                                             args[1],
                                             false).root);
  }
  ...
  {
    return new TypedAtom(TeXConstants.TYPE_INNER,
                         TeXConstants.TYPE_INNER,
                         new TeXFormula(tp,
                                        args[1],
                                        false).root);
  }
  ...
  public static final Atom joinrel_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    return new TypedAtom(TeXConstants.TYPE_RELATION,
                         TeXConstants.TYPE_RELATION,
                         new SpaceAtom(TeXConstants.UNIT_MU,
                                       -2.6f,
                                       0,
                                       0));
  }
  ...
  {
    return new SmashedAtom(new TeXFormula(tp,
                                          args[1],
                                          false).root,
                           args[2]);
  }
  ...
  public static final Atom left_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    if (left instanceof SymbolAtom && right instanceof SymbolAtom)
    {
      TeXFormula tf = new TeXFormula(tp,
                                     grp,
                                     false);
      return new FencedAtom(tf.root,
                            (SymbolAtom) left,
                            tf.middle,
                            (SymbolAtom) right);
    }
  ...
  public static final Atom leftparenthesis_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    return new MathAtom(new TeXFormula(tp,
                                       grp,
                                       false).root,
  ...
  {
    return new MiddleAtom(new TeXFormula(tp,
                                         args[1]).root);
  }
  ...
  public static final Atom intertext_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    Atom at = new RomanAtom(new TeXFormula(tp,
                                           str,
                                           "mathnormal",
                                           false,
                                           false).root);
  ...
  public static final Atom smallmatrixATATenv_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    parser.parse();
    array.checkDimensions();
    return new MatrixAtom(tp.getIsPartial(),
                          array,
                          MatrixAtom.SMALLMATRIX);
  }
  ...
  {
    int n = Integer.parseInt(args[1]);
    tp.addAtom(new MulticolumnAtom(n,
                                   args[2],
                                   new TeXFormula(tp,
                                                  args[3]).root));
  ...
  public static final Atom multlineATATenv_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    return new MultlineAtom(tp.getIsPartial(),
                            array,
                            MultlineAtom.MULTLINE);
  }
  ...
  {
    return new FBoxAtom(new TeXFormula(tp,
                                       args[1],
                                       false).root);
  }
  ...
  public static final Atom questeq_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    Atom at = new UnderOverAtom(SymbolAtom.get(TeXFormula.symbolMappings['=']),
                                new ScaleAtom(SymbolAtom.get(TeXFormula.symbolMappings['?']),
                                              0.75f),
                                TeXConstants.UNIT_MU,
                                2.5f,
                                true,
                                true);
    return new TypedAtom(TeXConstants.TYPE_RELATION,
  ...
  {
    Atom at = new UnderOverAtom(new TeXFormula(tp,
                                               args[2],
                                               false).root,
                                new TeXFormula(tp,
                                               args[3],
  ...
  {
    return new UnderOverAtom(new TeXFormula(tp,
                                            args[2],
                                            false).root,
                             new TeXFormula(tp,
                                            args[1],
  ...
  public static final Atom undertilde_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    Atom at = new TeXFormula(tp,
                             args[1],
                             false).root;
    return new UnderOverAtom(at,
                             new AccentedAtom(new PhantomAtom(at,
                                                              true,
                                                              false,
                                                              false),
                                              "widetilde"),
  ...
  {
    return new BoldAtom(new RomanAtom(new TeXFormula(tp,
                                                     args[1],
                                                     false).root));
  }
  ...
  {
    return new TtAtom(new TeXFormula(tp,
                                     args[1],
                                     false).root);
  }
  ...
  {
    return new ItAtom(new TeXFormula(tp,
                                     args[1],
                                     false).root);
  }
  ...
  {
    return new SsAtom(new TeXFormula(tp,
                                     args[1],
                                     false).root);
  }
  ...
  {
    return new PhantomAtom(new TeXFormula(tp,
                                          args[1],
                                          false).root,
                           true,
                           false,
  ...
  public static final Atom big_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    return new BigDelimiterAtom((SymbolAtom) at,
                                1);
  }
  ...
  public static final Atom bigl_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    Atom att = new BigDelimiterAtom((SymbolAtom) at,
                                    1);
  ...
  {
    return new ResizeAtom(new TeXFormula(tp,
                                         args[3]).root,
                          args[1],
                          args[2],
  ...
  public static final Atom raisebox_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    return new RaiseAtom(new TeXFormula(tp,
                                        args[2]).root,
                         (int) raise[0],
                         raise[1],
                         (int) height[0],
  ...
  public static final Atom fgcolor_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    try
    {
      return new ColorAtom(new TeXFormula(tp,
                                          args[2]).root,
                           null,
  ...
  public static final Atom cong_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    vra.add(new SpaceAtom(TeXConstants.UNIT_MU,
                          0f,
                          1.5f,
                          0f));
  ...
  {
    return new JavaFontRenderingAtom(args[1],
                                     Font.PLAIN);
  }
  ...
  public static final Atom size_macros(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    return new MonoScaleAtom(new TeXFormula(tp,
                                            tp.getOverArgument(),
                                            null,
                                            false,
                                            tp.isIgnoreWhiteSpace()).root,
  ...
  {
    return new CumulativeScriptsAtom(tp.getLastAtom(),
                                     null,
                                     new TeXFormula(tp,
                                                    args[1]).root);
  }
  ...
  public static final Atom geoprop_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    ddot.add(new SpaceAtom(TeXConstants.UNIT_MU,
                           4f,
                           0f,
                           0f));
  ...
  public static final Atom minuscolon_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    at.add(new SpaceAtom(TeXConstants.UNIT_EM,
                         ...
                         0f,
                         0f));
    at.add(new UnderOverAtom(SymbolAtom.get("normaldot"),
                             SymbolAtom.get("normaldot"),
                             TeXConstants.UNIT_MU,
                             5.2f,
                             false,
  ...
  {
    RowAtom ra = new RowAtom(new SpaceAtom(TeXConstants.UNIT_EX,
                                           -0.1f,
                                           0f,
                                           0f));
    ra.add(SymbolAtom.get("bar"));
    VRowAtom vra = new VRowAtom(new LapedAtom(ra,
                                              'r'));
    vra.setRaise(TeXConstants.UNIT_EX, -0.1f);
    RowAtom at = new RowAtom(vra);
    at.add(new RomanAtom(new CharAtom('h',
                                      tp.formula.textStyle)));
    return at;
  }
  ...
  public static final Atom dstrok_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    vra.setRaise(TeXConstants.UNIT_EX, -0.1f);
    RowAtom at = new RowAtom(vra);
    at.add(new RomanAtom(new CharAtom('d',
                                      tp.formula.textStyle)));
    return at;
  }
  ...
  public static final Atom kern_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    return new SpaceAtom((int) info[0],
                         info[1],
                         0f,
                         0f);
  }
  ...
  {
    return new SpaceAtom(TeXConstants.UNIT_EM,
                         1f,
                         0f,
                         0f);
  }
  ...
  public static final Atom iint_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    ra.add(new SpaceAtom(TeXConstants.UNIT_MU,
                         -6f,
                         0f,
                         0f));
    ra.add(integral);
  ...
  public static final Atom idotsint_macro(final TeXParser tp, final String[] args) throws ParseException
  {
    ...
    cdots.add(cdotp);
    cdots.add(cdotp);
    ra.add(new TypedAtom(TeXConstants.TYPE_INNER,
                         TeXConstants.TYPE_INNER,
                         cdots));
    ra.add(new SpaceAtom(TeXConstants.UNIT_MU,
                         -1f,
  ...
  {
    Atom at = new BigDelimiterAtom((SymbolAtom) SymbolAtom.get("lmoustache").clone(),
                                   1);
  ...
  {
    Atom at = new BigDelimiterAtom((SymbolAtom) SymbolAtom.get("rmoustache").clone(),
                                   1);
