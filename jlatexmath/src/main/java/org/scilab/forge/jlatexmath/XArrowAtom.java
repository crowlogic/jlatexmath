 ...
 */
public class XArrowAtom extends
                        Atom
{
  ...
  public Box createBox(TeXEnvironment env)
  {
    Box         O     = over != null ? over.createBox(env.supStyle()) : new StrutBox(0,
                                                                                     ...
                                                                                     0,
                                                                                     0);
    Box         U     = under != null ? under.createBox(env.subStyle()) : new StrutBox(0,
                                                                                       0,
                                                                                       0,
                                                                                       0);
    Box         oside = new SpaceAtom(TeXConstants.UNIT_EM,
                                      1.5f,
                                      0,
                                      0).createBox(env.supStyle());
    Box         uside = new SpaceAtom(TeXConstants.UNIT_EM,
                                      1.5f,
                                      0,
                                      0).createBox(env.subStyle());
    Box         sep   = new SpaceAtom(TeXConstants.UNIT_MU,
                                      0,
                                      2f,
                                      0).createBox(env);
    ...
    Box         ohb   = new HorizontalBox(O,
                                          width,
                                          TeXConstants.ALIGN_CENTER);
    Box         uhb   = new HorizontalBox(U,
                                          width,
                                          TeXConstants.ALIGN_CENTER);
    ...
    HorizontalBox hb = new HorizontalBox(vb,
                                         vb.getWidth() + 2 * sep.getHeight(),
                                         TeXConstants.ALIGN_CENTER);
    return hb;
  }
}
