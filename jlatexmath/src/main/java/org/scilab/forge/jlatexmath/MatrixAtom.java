 ...
 */
public class MatrixAtom extends
                        Atom
{

  public static SpaceAtom         hsep         = new SpaceAtom(TeXConstants.UNIT_EM,
                                                               1f,
                                                               0.0f,
                                                               0.0f);
  public static SpaceAtom         semihsep     = new SpaceAtom(TeXConstants.UNIT_EM,
                                                               ...
                                                               0.0f,
                                                               0.0f);
  public static SpaceAtom         vsep_in      = new SpaceAtom(TeXConstants.UNIT_EX,
                                                               0.0f,
                                                               1f,
                                                               0.0f);
  ...
  private static final Box        nullBox      = new StrutBox(0,
                                                              0,
                                                              0,
                                                              0);
    ...
    for (int i = 0; i < row; i++)
    {
      ...
      for (int j = 0; j < col; j++)
      {
        ...
        case TeXConstants.TYPE_MULTICOLUMN:
          ...
          {
            hb.add(new HorizontalBox(boxarr[i][j],
                                     rowWidth[j],
                                     position[j]));
          }
          else
          ...
          if (lastVline && vlines.get(j + 1) != null)
          {
            ...
            {
              hb.add(new HorizontalBox(vatBox,
                                       Hsep[j + 1].getWidth() + vatBox.getWidth(),
                                       TeXConstants.ALIGN_CENTER));
            }
            else
            {
        ...
        case TeXConstants.TYPE_INTERTEXT:
          ...
          hb = new HorizontalBox(boxarr[i][j],
                                 f,
                                 TeXConstants.ALIGN_LEFT);
          j = col - 1;
          break;
