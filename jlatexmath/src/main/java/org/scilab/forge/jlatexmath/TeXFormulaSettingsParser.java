...
public class TeXFormulaSettingsParser
{
  ...
  {
    this(GlueSettingsParser.class.getResourceAsStream(RESOURCE_NAME),
         RESOURCE_NAME);
  }
  ...
  private static void
          addToMap(NodeList mapList, String[] tableMath, String[] tableText) throws ResourceParseException
  {
  ...
  private static void
          addFormulaToMap(NodeList mapList, String[] tableMath, String[] tableText) throws ResourceParseException
  {
    for (int i = 0; i < mapList.getLength(); i++)
    {
      Element map     = (Element) mapList.item(i);
